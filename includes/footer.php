...
<h3>Food by Mood Project</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> A system designed to provide foods from companies/sellers to customers according to their food choices and moodswings.</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">admin@foodmood.net</a></span>
                </div>
            </li>
